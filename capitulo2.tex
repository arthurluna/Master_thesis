...
Quanto maior for o centro espalhador, mais afetado o campo será, e a partir de um certo raio, o termo de espalhamento da força domina. A imagem \ref{Kphi_raio} mostra o comportamento da constante de torção $\kappa_\phi$.
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=.7]{Kphi_Artigo_Kaina}
\caption{{\bf acertar dimensões(kappa c / P n1), trocar titulo, colocar informações sobre os dados (comp de onda, aberração esferica, ausencia de astig, polarização, etc.).}}
\label{Kphi_raio}
\end{center}
\end{figure}
%s
