...
\caption{Centro da microesfera (indicado pelo "x") no eixo do cone, acima (esquerda) e abaixo (direita) da posição do foco (indicado pelo centro do círculo, para onde o vetor $\delta{\mathbf p}$ aponta). O momento que a esfera adquire ${\mathbf\delta P}$ é $-({\mathbf \it P'}-{\mathbf \it P}$), que é menos a variação de momento do campo, por conservação.}
\label{foco_axial}
\end{center}
\end{figure}
