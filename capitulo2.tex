...
\end{equation}
%
é a função de aberração esférica. No experimento, essa aberração aparece depois que o feixe é focalizado pela objetiva de imersão em óleo (que tem o mesmo índice de refração do vidro) e passa pela interface vidro-água.
...
Uma breve explicação das aberrações será feita a seguir, baseada em trabalhos do grupo \cite{Dutra2014, Dutra, Diniz2019}
