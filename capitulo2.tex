...
Recentemente, em 2015, a aproximação de ótica geométrica foi usada para se obter a força ótica em objetos elipsoidais numéricamente \cite{Callegari2015}.
...
Os modelos baseados em ótica geométrica e aproximação do centro espalhador por um dipolo tem relativa boa concordância com experimentos. Por outro lado, não são válidos para os tamanhos intermediários de raios, que são amplamente utilizados nos experimentos. Para descrever esses casos, é necessário um modelo baseado em ótica ondulatória, que leve em conta o espalhamento do feixe pela esfera. Antes de tratar do modelo MD, apresentaremos outros modelos e formas de calculos de forças óticas.

\section{Uma abordagem de ótica ondulatória}
\label{mod_oo}

Na tentativa de obter um modelo baseado em ótica ondulatória, o modelo de Gouesbet e Gréhan faz uma generalização do modelo de Lorenz e Mie para o espalhamento de uma onda plana (circularmente polarizada) por uma esfera \cite{Mie1908,Lorenz1890}, onde o feixe incidente passa a ser arbitrário. Tanto o feixe espalhado como o incidente são obtidos 
