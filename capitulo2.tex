...
\end{equation}
%
é a função de aberração esférica. No experimento, essa aberração aparece depois que o feixe é focalizado pela objetiva de imersão em óleo (que tem o mesmo índice de refração do vidro), onde o feixe passa pela interface vidro-água
